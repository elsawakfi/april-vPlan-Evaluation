...
REQUIREMENT_REGEX = re.compile(
    ...
    r'is not supproted | are not supported|'
    ...
    r'no component can terminate|'
    r'can disable further writing|'
...
#     r'shall|must|must not|should|cannot|can not|'
#     r'can only be| can be up to| can be lower than|can be higher than|'
#     r'length can be| length can be up to|'
#     r'is not supported|is not allowed|is not permitted|'
#     r'not permitted to|permitted to|is permitted to|are permitted to|'
#     r'required to|is required to|are required to|'
#     r'is required|are required|'
#     r'not allowed to|allowed to|'
#     r'remains asserted|remain asserted|'
#     r'can be asserted|can be deasserted|'
#     r'may be asserted|may be deasserted|'
#     r'shall be asserted|shall be deasserted|'
#     r'indicates that|can be sent|'
#     r'must be ordered|'
#     r'is optional|are optional|'
#     r'is valid|are valid|is invalid|are invalid|'
#     r'is only valid|are only valid|'
#     r'must remain|must be held|must be stable|remain stable|'
#     r'indicates that|can be sent|'
#     r'must be ordered|'
#     r'is returned|'
#     r'is issued|'
#     r'is generated|'
#     r'is valid only when| can only be | is valid only|'
#     r'is not supported'
#     r'can terminate | can disable|'
#     r'may not'
#     r'is prohibited|are prohibited|'
#     r')\b',
#     re.IGNORECASE
# )
